    ...
    <>
      ...
      >
        <Grid item md={9} mb={12}>
          <Reveal>
            <Typography variant="h2" fontWeight={700} color={'white'}>Jerome M. Mamangun</Typography>
            <Typography variant="h4" fontWeight={700} color={'white'} mb={4}>CTO - PH</Typography>
            <Typography variant="h4" fontWeight={700} color={'#E3C263'}>jmm@seventh-pillar.com</Typography>
            <Typography variant="h4" fontWeight={700} color={'#E3C263'}>+02 8334 2616</Typography>
            <Typography variant="h4" fontWeight={700} color={'#E3C263'}>+63 917 550 2529</Typography>
