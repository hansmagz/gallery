    ...
    <>
      ...
      >
        <Grid item md={9} mb={12}>
          <Reveal>
            <Typography variant="h2" fontWeight={700} color={'white'}>Jerome R. Aganon</Typography>
            <Typography variant="h4" fontWeight={700} color={'white'} mb={4}>Board of Director</Typography>
            <Typography variant="h4" fontWeight={700} color={'#E3C263'}>jar@seventh-pillar.com</Typography>
            <Typography variant="h4" fontWeight={700} color={'#E3C263'}>+02 8334 2616</Typography>
            <Typography variant="h4" fontWeight={700} color={'#E3C263'}>+1 702 858 7312</Typography>
