    ...
    <>
      ...
      >
        <Grid item md={9} mb={12}>
          <Reveal>
            <Typography variant="h2" fontWeight={700} color={'white'}>Jonash P. Bundalian</Typography>
            <Typography variant="h4" fontWeight={700} color={'white'} mb={4}>CTO - USA</Typography>
            <Typography variant="h4" fontWeight={700} color={'#E3C263'}>jpb@seventh-pillar.com</Typography>
            <Typography variant="h4" fontWeight={700} color={'#E3C263'}>+02 8334 2616</Typography>
            <Typography variant="h4" fontWeight={700} color={'#E3C263'}>+1 310 221 1464</Typography>
