    ...
    <>
      ...
      >
        <Grid item md={9} mb={12}>
          <Reveal>
            <Typography variant="h2" fontWeight={700} color={'white'}>Anna B. Marcelo</Typography>
            <Typography variant="h4" fontWeight={700} color={'white'} mb={4}>Business Development Manager</Typography>
            <Typography variant="h4" fontWeight={700} color={'#E3C263'}>jmarcelo@seventh-pillar.com</Typography>
            <Typography variant="h4" fontWeight={700} color={'#E3C263'}>+02 8334 2616</Typography>
            <Typography variant="h4" fontWeight={700} color={'#E3C263'}>+63 917 855 2997</Typography>
