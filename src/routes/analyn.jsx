    ...
    <>
      ...
      >
        <Grid item md={9} mb={12}>
          <Reveal>
            <Typography variant="h2" fontWeight={700} color={'white'}>Analyn R. Ruelo</Typography>
            <Typography variant="h4" fontWeight={700} color={'white'} mb={4}>Consultant</Typography>
            <Typography variant="h4" fontWeight={700} color={'#E3C263'}>aruelo@seventh-pillar.com</Typography>
            <Typography variant="h4" fontWeight={700} color={'#E3C263'}>+02 8334 2616</Typography>
            <Typography variant="h4" fontWeight={700} color={'#E3C263'}>+63 976 070 8768</Typography>
