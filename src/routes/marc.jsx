    ...
    <>
      ...
      >
        <Grid item md={9} mb={12}>
          <Reveal>
            <Typography variant="h2" fontWeight={700} color={'white'}>Marc Hussein P. Bundalian</Typography>
            <Typography variant="h4" fontWeight={700} color={'white'} mb={4}>President & COO</Typography>
            <Typography variant="h4" fontWeight={700} color={'#E3C263'}>mbundalian@seventh-pillar.com</Typography>
            <Typography variant="h4" fontWeight={700} color={'#E3C263'}>+02 8334 2616</Typography>
            <Typography variant="h4" fontWeight={700} color={'#E3C263'}>+63 966 907 0849</Typography>
