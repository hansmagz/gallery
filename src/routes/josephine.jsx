    ...
    <>
      ...
      >
        <Grid item md={9} mb={12}>
          <Reveal>
            <Typography variant="h2" fontWeight={700} color={'white'}>Josephine R. Bendijo</Typography>
            <Typography variant="h4" fontWeight={700} color={'white'} mb={4}>Head Admin</Typography>
            <Typography variant="h4" fontWeight={700} color={'#E3C263'}>jbendijo@seventh-pillar.com or jbendijo@taraapps.com</Typography>
            <Typography variant="h4" fontWeight={700} color={'#E3C263'}>+02 8334 2616</Typography>
            <Typography variant="h4" fontWeight={700} color={'#E3C263'}>+63 976 368 7425</Typography>
